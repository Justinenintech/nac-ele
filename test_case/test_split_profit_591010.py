...
class NacSplitProfit591010(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_591010(self.number, SPLIT_DETAIL)
    ...
    def check_profit_loss(self, parameter):
        ...
        bs = ls_profit[0].split(',')
        count = len(list(set(SPLIT_DETAIL).difference(set(bs))))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit591010], html_report=report + "\\nac_split_profit_report.html",
