...
class NacSplitProfit191310_4(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.straight_semi_smooth(self.number, '前三', 1)  # ran:1 半顺，ran：2 顺子，ran：3 杂六
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit191310_4], html_report=report + "\\nac_split_profit_report.html",
