...
BETS = len(_tool.count_11x5_751214(SPLIT_DETAIL))
print('_tool.bet_11x5_751210(SPLIT_DETAIL)',_tool.bet_11x5_751214x16(_tool.count_11x5_751214(SPLIT_DETAIL)))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751214(object):
    def __init__(self):
    ...
    def get_split_number(self):
        # for parameter in
        result = self.split.split_751210(_tool.bet_11x5_751214x16(_tool.count_11x5_751214(SPLIT_DETAIL)))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751214], html_report=report + "\\nac_split_profit_report.html",
