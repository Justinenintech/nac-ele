...
SPLIT_DETAIL = [''.join(list(map(str, i))) for i in list(it.combinations(_DETAIL, 1))]
...
class NacSplitProfit121212(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            result = self.split.split_121212(self.number, parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit121212], html_report=report + "\\nac_split_profit_report.html",
