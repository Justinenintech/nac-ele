...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_11x5_701010(BET_DETAIL)
...
class NacSplitProfit701010(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_701010(SPLIT_DETAIL)
    ...
    def check_split_detail(self):
        ...
        print('bet_type_code',bet_type_code)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit701010], html_report=report + "\\nac_split_profit_report.html",
