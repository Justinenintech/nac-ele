...
print(AMOUNT)
SPLIT_DETAIL = list(map(str, BET_DETAIL.split('|')))
print('SPLIT_DETAIL', SPLIT_DETAIL)
BETS = len(_tool.bet_11x5_number(SPLIT_DETAIL,2))
print('_tool.bet_11x5_number(SPLIT_DETAIL,2)',_tool.bet_11x5_number(SPLIT_DETAIL,2))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751011(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_75100x3(_tool.bet_11x5_number(SPLIT_DETAIL,2))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751011], html_report=report + "\\nac_split_profit_report.html",
