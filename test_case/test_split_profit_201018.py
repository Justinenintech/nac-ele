...
class NacSplitProfit201018(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_201018(self.number)
    ...
    def check_profit_loss(self, parameter):
        ...
        theory_bonus = self._sql.nac_theory_bonus('20_10_10_9')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit201018], html_report=report + "\\nac_split_profit_report.html",
