...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_11x5_701011(BET_DETAIL)
...
class NacSplitProfit751115(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_75104x7(list(SPLIT_DETAIL[0]),5)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751115], html_report=report + "\\nac_split_profit_report.html",
