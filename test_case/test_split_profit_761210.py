...
# print(slotList1)
c = r'numbers":"(.*?)",'
SPLIT_DETAIL = re.findall(c, BET_DETAIL)
print(SPLIT_DETAIL)
...
class NacSplitProfit761210(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            result = self.split.split_761210(parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit761210], html_report=report + "\\nac_split_profit_report.html",
