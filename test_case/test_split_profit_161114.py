...
# @Author  : Eagle
# @Site    : 
# @File    : test_split_profit_161114.py
# @Time    : 2021/6/28 0:59
# @Software: PyCharm
import random
import time
...
class NacSplitProfit161114(object):
    def __init__(self):
    ...
    def get_split_number(self):
        ...
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_161114(self.number, int(before[0]), int(before[1]), int(before[2]),
                                             str(reverse_dict.get(2)), str(reverse_dict.get(1)))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161114], html_report=report + "\\nac_split_profit_report.html",
