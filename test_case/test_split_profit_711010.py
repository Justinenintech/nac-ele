...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_11x5_711010(BET_DETAIL)
...
class NacSplitProfit711010(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_711010(SPLIT_DETAIL)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit711010], html_report=report + "\\nac_split_profit_report.html",
