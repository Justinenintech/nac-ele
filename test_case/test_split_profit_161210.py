...
class NacSplitProfit161210(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            # print('afters', afters)
            result = self.split.split_161210(self.number, int(before[0]), int(before[1]), int(before[2]), int(before[3]),afters)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161210], html_report=report + "\\nac_split_profit_report.html",
