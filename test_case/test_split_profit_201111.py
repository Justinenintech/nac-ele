...
class NacSplitProfit201111(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for value in set(DETAIL):
            result = self.split.split_201111(value,self.number)
    ...
    def res_be_detail(self):
        ...
        while True:
            try:
                ...
                res = _tool.get_double_sided_params(1,3,lot_code=LOT_CODE, bet_code='20_11_11',
                                                    amount=AMOUNT,
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit201111], html_report=report + "\\nac_split_profit_report.html",
