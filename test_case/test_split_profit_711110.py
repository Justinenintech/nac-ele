...
class NacSplitProfit711110(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_711110(_tool.bet_11x5_number(SPLIT_DETAIL,2))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit711110], html_report=report + "\\nac_split_profit_report.html",
