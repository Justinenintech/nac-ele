...
class NacSplitProfit601110(object):
    def __init__(self):
    ...
    def get_split_number(self):
        lis = [2, 3, 5, 6]
        par1 = list(it.combinations(lis, 3))
        par2 = list(it.combinations(lis, 2))
        for parameter in (par1+par2):
            result = self.split.split_601110(self.number,parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit601110], html_report=report + "\\nac_split_profit_report.html",
