...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_detail_single_twin(BET_DETAIL, 2,2)
print(SPLIT_DETAIL)
...
class NacSplitProfit161013(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_161013(self.number, int(before[0]), int(before[1]),list(parameter.values()))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161013], html_report=report + "\\nac_split_profit_report.html",
