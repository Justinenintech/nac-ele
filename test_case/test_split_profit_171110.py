...
class NacSplitProfit171110(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            # print('afters', afters)
            result = self.split.split_171110(self.number, int(before[0]), int(before[1]), afters)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit171110], html_report=report + "\\nac_split_profit_report.html",
