...
class NacSplitProfit201012(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_201012(self.number)
    ...
    def check_profit_loss(self, parameter):
        ...
        theory_bonus = self._sql.nac_theory_bonus('20_10_10_3')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit201012], html_report=report + "\\nac_split_profit_report.html",
