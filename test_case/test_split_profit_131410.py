...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_detail_131410(BET_DETAIL, 2)
...
class NacSplitProfit131410(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_131410x11(self.number, '前二',parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit131410], html_report=report + "\\nac_split_profit_report.html",
