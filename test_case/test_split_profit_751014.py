...
BETS = len(_tool.bet_11x5_number(SPLIT_DETAIL,5))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751014(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_75104x7(SPLIT_DETAIL,5)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751014], html_report=report + "\\nac_split_profit_report.html",
