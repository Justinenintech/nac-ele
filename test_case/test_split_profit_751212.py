...
BETS = len(_tool.bet_11x5_751212(SPLIT_DETAIL))
print('_tool.bet_11x5_751210(SPLIT_DETAIL)',_tool.bet_11x5_751212(SPLIT_DETAIL))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751212(object):
    def __init__(self):
    ...
    def get_split_number(self):
        # for parameter in
        result = self.split.split_751210(_tool.bet_11x5_751212(SPLIT_DETAIL))
    ...
    #             res = _tool.get_params(20,3,lot_code=LOT_CODE, bet_code=BET_CODE,
    #                                    amount=AMOUNT,
    ...
    def check_split_detail(self):
        ...
        result = _tool.get_split_api('sd11x5', BET_CODE, BET_DETAIL)  # 获取API拆号结果
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751212], html_report=report + "\\nac_split_profit_report.html",
