...
class NacSplitProfit191310_2(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.straight_semi_smooth(self.number, '前三', 2)  # ran:1 半顺，ran：2 顺子，ran：3 杂六
    ...
    def res_be_detail(self):
        ...
        while True:
            try:
                ...
                res = _tool.get_double_sided_params(1,3,lot_code=LOT_CODE, bet_code='19_13_10',
                                                    amount=AMOUNT,
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit191310_2], html_report=report + "\\nac_split_profit_report.html",
