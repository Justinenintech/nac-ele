...
class NacSplitProfit201011(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_201011(self.number)
    ...
    def res_be_detail(self):
        ...
        while True:
            try:
                ...
                res = _tool.get_double_sided_params(1,3,lot_code=LOT_CODE, bet_code='20_10_10',
                                                    amount=AMOUNT,
    ...
    def check_profit_loss(self, parameter):
        ...
        theory_bonus = self._sql.nac_theory_bonus('20_10_10_2')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit201011], html_report=report + "\\nac_split_profit_report.html",
