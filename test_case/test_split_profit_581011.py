...
DETAIL = re.findall(regex, BET_DETAIL)
print(DETAIL)
BETS = len(re_results)
print('BETS', BETS)
OPEN_NUMBER = '99999'
...
class NacSplitProfit581011(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in DETAIL:
            result = self.split.split_581011(self.number, parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit581011], html_report=report + "\\nac_split_profit_report.html",
