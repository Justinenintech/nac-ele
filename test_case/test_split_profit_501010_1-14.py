...
class NacSplitProfit501010(object):
    def __init__(self):
    ...
    def check_profit_loss(self, parameter):
        ...
        theory_bonus = self._sql.nac_theory_bonus('50_10_10_5')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit501010], html_report=report + "\\nac_split_profit_report.html",
