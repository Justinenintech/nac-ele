...
#     print(i.split('|'))
#     ls.append(i.split('|'))
# for i in list(itertools.product(ls[0],ls[1])):
#     # print('i',int(i[0]) % 10)
#     if (int(i[0]) % 10) < int(i[1]):
#         # print(i[0]+i[1])
#         SPLIT_DETAIL.append(i[0]+i[1])
#     elif (int(i[0]) % 10) > int(i[1]):
#         # print(i[1] + i[0])
#         SPLIT_DETAIL.append(i[1] + i[0])
...
class NacSplitProfit531010(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_531010(self.number, SPLIT_DETAIL)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit531010], html_report=report + "\\nac_split_profit_report.html",
