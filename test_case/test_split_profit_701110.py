...
class NacSplitProfit701110(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_701110(_tool.bet_11x5_number(SPLIT_DETAIL,3))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit701110], html_report=report + "\\nac_split_profit_report.html",
