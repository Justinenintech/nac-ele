...
class NacSplitProfit701112(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_701111(_tool.bet_11x5_701112(SPLIT_DETAIL))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit701112], html_report=report + "\\nac_split_profit_report.html",
