...
class NacSplitProfit121121_2(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            result = self.split.split_121121(self.number, parameter)
    ...
    def search_profit_loss(self):
        rec = _tool.get_profit_loss(SPLIT_LIST, '27300') # random.choice(SPLIT_LIST)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit121121_2], html_report=report + "\\nac_split_profit_report.html",
