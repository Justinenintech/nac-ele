...
class NacSplitProfit161117(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_161117(self.number, int(before[0]), int(before[1]), int(before[2]),
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161117], html_report=report + "\\nac_split_profit_report.html",
