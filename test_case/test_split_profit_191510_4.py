...
class NacSplitProfit191510_4(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.straight_semi_smooth(self.number, '后三', 1)  # ran:1 半顺，ran：2 顺子
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit191510_4], html_report=report + "\\nac_split_profit_report.html",
