...
print('AMOUNT', AMOUNT)
DETAIL = re.findall(r"和", BET_DETAIL)
print(re.findall(r"和", BET_DETAIL))
...
class NacSplitProfit201110_1(object):
    def __init__(self):
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit201110_1], html_report=report + "\\nac_split_profit_report.html",
