...
# SPLIT_DETAIL = [''.join(list(map(str, i))) for i in list(it.combinations(_DETAIL, 3))]
...
class NacSplitProfit541010(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            result = self.split.split_541010(self.number, parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit541010], html_report=report + "\\nac_split_profit_report.html",
