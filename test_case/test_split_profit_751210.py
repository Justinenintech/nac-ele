...
BETS = len(_tool.bet_11x5_711112(SPLIT_DETAIL))
...
class NacSplitProfit751210(object):
    def __init__(self):
    ...
    def get_split_number(self):
        # for parameter in
        result = self.split.split_751210(_tool.bet_11x5_711112(SPLIT_DETAIL))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751210], html_report=report + "\\nac_split_profit_report.html",
