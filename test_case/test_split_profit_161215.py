...
BETS = len(_tool.bet_ssc_161215(SPLIT_DETAIL))
print('_tool.bet_11x5_701112(SPLIT_DETAIL)', _tool.bet_ssc_161215(SPLIT_DETAIL))
# for  i in _tool.bet_ssc_161215(SPLIT_DETAIL):
#     print(i.keys())
DETAIL = _tool.bet_detail_161213(BET_DETAIL, 4, _tool.bet_ssc_161215(SPLIT_DETAIL))
print("_tool.bet_detail_161215(BET_DETAIL,4,_tool.bet_ssc_161215(SPLIT_DETAIL))",
      _tool.bet_detail_161213(BET_DETAIL, 4, _tool.bet_ssc_161215(SPLIT_DETAIL)))
# for i in _tool.bet_detail_161213(BET_DETAIL, 4, _tool.bet_ssc_161215(SPLIT_DETAIL)):
#     print(list(i.keys())[0][0])
#     print(i.values())
#     print("二重号", list(list(i.values())[0].keys())[0])
#     print("单号", list(list(i.values())[0].values())[0])
print('BETS', BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit161215(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in DETAIL:
            result = self.split.split_161215(self.number, int(list(parameter.keys())[0][0]),
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161215], html_report=report + "\\nac_split_profit_report.html",
