...
BETS = len(_tool.bet_11x5_701112(SPLIT_DETAIL))
print('_tool.bet_11x5_701112(SPLIT_DETAIL)',_tool.bet_11x5_711112(SPLIT_DETAIL))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit711112(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_711112(_tool.bet_11x5_711112(SPLIT_DETAIL))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit711112], html_report=report + "\\nac_split_profit_report.html",
