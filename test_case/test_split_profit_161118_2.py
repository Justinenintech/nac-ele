...
class NacSplitProfit161118(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_161118(self.number, int(before[0]), int(before[1]), int(before[2]),
                                             str(afters[0]), str(afters[1]), str(afters[2]))
    ...
    def search_profit_loss(self):
        ...
        rec = _tool.get_profit_loss(SPLIT_LIST, '47319')
    ...
    def check_profit_loss(self, parameter):
        ...
        theory_bonus = self._sql.nac_theory_bonus('16_11_18_2')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161118], html_report=report + "\\nac_split_profit_report.html",
