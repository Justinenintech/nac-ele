...
BET_DETAIL = _yaml['detail'].get(PROJECT + '_' + BET_CODE + '_8')
...
class NacSplitProfit311010_8(object):
    def __init__(self):
    ...
    def check_split_detail(self):
        ...
        theory_bonus = self._sql.nac_theory_bonus(BET_CODE + '_8')[1].get('theory_bonus')
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit311010_8], html_report=report + "\\nac_split_profit_report.html",
