...
print(AMOUNT)
SPLIT_DETAIL = _tool.bet_detail_121410(BET_DETAIL, 3)
...
class NacSplitProfit121412(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_121410x12(self.number, '后三',parameter)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit121412], html_report=report + "\\nac_split_profit_report.html",
