...
class NacSplitProfit121128_2(object):
    def __init__(self):
    ...
    def search_profit_loss(self):
        rec = _tool.get_profit_loss(SPLIT_LIST, '56405') # random.choice(SPLIT_LIST)
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit121128_2], html_report=report + "\\nac_split_profit_report.html",
