...
class NacSplitProfit161014(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            ...
            result = self.split.split_161014(self.number, int(before[0]), int(before[1]), list(parameter.values()))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit161014], html_report=report + "\\nac_split_profit_report.html",
