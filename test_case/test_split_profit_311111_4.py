...
BET_DETAIL = _yaml['detail'].get(PROJECT + '_' + BET_CODE + '_4')
...
class NacSplitProfit311010_4(object):
    def __init__(self):
    ...
    def check_split_detail(self):
        ...
        theory_bonus = self._sql.nac_theory_bonus(BET_CODE + '_4')[1].get('theory_bonus')
        print('theory_bonus',theory_bonus)
        _bonus = [-float(theory_bonus)]
        print('set_theory_bonus',set(_bonus))
        for i in result[1].items():
            # print(i[0],i[1])
            if sum(list(map(int,i[0].split(',')))[4:6]) in SPLIT_DETAIL:
                # print(i[1])
        ...
        false_num = [0.0]
        print('false_bonus_result',set(false_bonus_result))
        print('set(false_num',set(false_num))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit311010_4], html_report=report + "\\nac_split_profit_report.html",
