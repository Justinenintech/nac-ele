...
BETS = len(_tool.bet_11x5_number(SPLIT_DETAIL,4))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751013(object):
    def __init__(self):
    ...
    def get_split_number(self):
        result = self.split.split_75100x3(_tool.bet_11x5_number(SPLIT_DETAIL,4))
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751013], html_report=report + "\\nac_split_profit_report.html",
