...
class NacSplitProfit121114_2(object):
    def __init__(self):
    ...
    def get_split_number(self):
        for parameter in SPLIT_DETAIL:
            result = self.split.split_121114(self.number, parameter)
    ...
    def search_profit_loss(self):
        rec = _tool.get_profit_loss(SPLIT_LIST, '06086') # random.choice(SPLIT_LIST)
    ...
    def check_profit_loss(self, parameter):
        ...
        [tlt.setdefault(i, open_number[:3].count(i)) for i in open_number[:3]]
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit121114_2], html_report=report + "\\nac_split_profit_report.html",
