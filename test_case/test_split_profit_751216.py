...
print(AMOUNT)
SPLIT_DETAIL = BET_DETAIL.split(',')
print('SPLIT_DETAIL', SPLIT_DETAIL)
BETS = len(_tool.count_11x5_751216(SPLIT_DETAIL))
print('_tool.bet_11x5_751210(SPLIT_DETAIL)',_tool.count_11x5_751216(SPLIT_DETAIL))
print('_tool.bet_11x5_751210(SPLIT_DETAIL)',_tool.bet_11x5_751214x16(_tool.count_11x5_751216(SPLIT_DETAIL)))
print(BETS)
SPLIT_LIST = []
OPEN_NUMBER = '99999'
PROFIT_LIST = []
...
class NacSplitProfit751216(object):
    def __init__(self):
    ...
    def get_split_number(self):
        # for parameter in
        result = self.split.split_751210(_tool.bet_11x5_751214x16(_tool.count_11x5_751216(SPLIT_DETAIL)))
    ...
    def res_be_detail(self):
        ...
        while True:
            try:
                ...
                res = _tool.get_params(1,-15,lot_code=LOT_CODE, bet_code=BET_CODE,
                                       amount=AMOUNT,
    ...
    def check_profit_loss(self, parameter):
        ...
        # ls_profit = str([','.join(list(sliced(open_number, 2)))]).replace("'", "\"").replace(r"\n", "")
        ls_profit = [','.join(list(sliced(open_number, 2)))]
...
if "__main__" == __name__:
    ...
    runner = Runner([NacSplitProfit751216], html_report=report + "\\nac_split_profit_report.html",
